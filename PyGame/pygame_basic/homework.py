...
# 화면 타이틀 설정
pygame.display.set_caption("Minjoo Game")  # 게임 이름
...
background = pygame.image.load(
    "/Users/parkminjoo/Desktop/Python Class/PyGame/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load(
    "/Users/parkminjoo/Desktop/Python Class/PyGame/pygame_basic/character.png")
...
enemy = pygame.image.load(
    "/Users/parkminjoo/Desktop/Python Class/PyGame/pygame_basic/enemy.png")
...
# 화면 가로의 절반 크기에 해당하는 곳에 위치 (가로)
enemy2_x_pos = (screen_width / 2) - (enemy_width / 2)
# 화면 세로 크기 가장 아래에 해당하는 곳에 위치 (세로)
enemy2_y_pos = (screen_height / 2) - (enemy_height / 2)
...
while running:
    ...
    enemy_x_pos += enemy_dx
    enemy_y_pos += enemy_dy

    # enemy2 위치 정의
    if enemy2_x_pos < 0 or enemy2_x_pos > (screen_width - enemy2_width):
        enemy2_dx = -enemy2_dx * 1.2
    if enemy2_y_pos < 0 or enemy2_y_pos > screen_height - enemy2_height:
        enemy2_dy = -enemy2_dy * 1.2

    enemy2_x_pos += enemy2_dx
    enemy2_y_pos += enemy2_dy
